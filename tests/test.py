...
def drawManagaLine():
    ...
    model.load_state_dict(torch.load(
        r"C:\_Dev\Repository\ComfyUI_windows_portable\ComfyUI\custom_nodes\comfyui_controlnet_aux\ckpts\lllyasviel\Annotators\erika.pth"))
    ...
    image_path = r"C:\_Dev\temp\ComfyUI_00010_.png"
    ...
    with torch.no_grad():
        ...
        y = model(tensor)
        print(image_path, torch.max(y), torch.min(y))
        ...
        cv2.imwrite(r"C:\_Dev\temp\line.jpg",yc[0:src.shape[0],0:src.shape[1]])
